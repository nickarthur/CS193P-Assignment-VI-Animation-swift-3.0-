...
enum BoardSquareType: String {
	...
	let boardColors: [String: UIColor] = [
		"backGround": #colorLiteral(red: 1, green: 0.99997437, blue: 0.9999912977, alpha: 1), "source": #colorLiteral(red: 0.7540688515, green: 0.7540867925, blue: 0.7540771365, alpha: 1), "regular": #colorLiteral(red: 0.8, green: 0.8, blue: 0.8, alpha: 1), "DL": #colorLiteral(red: 0.2202886641, green: 0.7022308707, blue: 0.9593387842, alpha: 1), "TL": #colorLiteral(red: 0.1431525946, green: 0.4145618975, blue: 0.7041897774, alpha: 1), "DW": #colorLiteral(red: 1, green: 0.4, blue: 0.6, alpha: 1), "TW": #colorLiteral(red: 0.8, green: 0, blue: 0, alpha: 1)]
	let mainBoardColors: [String: UIColor] = [
		"backGround": #colorLiteral(red: 0.1921568662, green: 0.007843137719, blue: 0.09019608051, alpha: 1)]

    let letterColors: [String: UIColor] = [
        "backGround": #colorLiteral(red: 0.7978851795, green: 0.7254901961, blue: 0.5294117647, alpha: 1), "animationBG": #colorLiteral(red: 0.7254902124, green: 0.4784313738, blue: 0.09803921729, alpha: 1), "border": #colorLiteral(red: 0.8, green: 0.8, blue: 0.8, alpha: 1), "tekst": #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), "tekstValue": #colorLiteral(red: 1, green: 0, blue: 0, alpha: 1), "score": #colorLiteral(red: 0.1431525946, green: 0.4145618975, blue: 0.7041897774, alpha: 1)]
...
enum PaddleConstants {
    static var HeigthPercentage: CGFloat = 1.6
    ...
    static var Color: UIColor =  #colorLiteral(red: 0.9529411793, green: 0.6862745285, blue: 0.1333333403, alpha: 1) //  #colorLiteral(red: 0.1921568662, green: 0.007843137719, blue: 0.09019608051, alpha: 1)
}
